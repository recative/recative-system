...
We provides a preview tool for developers to inspect their application on the
realtime, you can select your interactive program on the sidebar.

![Preview Tool](./images/preview-episodes.png)

There is also an environmental variable editor, which allows developers to test
the appearance of your program in different environments, you can check the
[detailed type definition](/api/ap-core/interface/IEnvVariable) of these
variables.

![Environmental Variable Editor](./images/preview-env-editor.png)
