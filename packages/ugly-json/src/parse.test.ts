...
describe('parse', () => {
  it('should parse correctly', () => {
    const originalData = JSON.parse(RAW_JSON_DATA);
    const parsedData = parse(stringify(RAW_JSON_DATA));
